...
apply_answers_file() {
  # The installer utility accepts a FILE, not stdin or the Perl tool's -c.
  # Never retry a failed database write as a supposed syntax check.
  installer_debconf_apply_file "$1"
}
