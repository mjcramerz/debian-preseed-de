...
desktop_stage_target_assets() {
  ...
  desktop_stage_role_asset etc/skel/.config/systemd/user/codex-app-server.service /etc/skel/.config/systemd/user/codex-app-server.service 0644
...
#  desktop_stage_role_asset_tree usr/share/backgrounds/other /usr/share/backgrounds/other
  ...
  desktop_stage_role_asset etc/skel/.config/zathura/zathurarc /etc/skel/.config/zathura/zathurarc 0644
...
' sh
  ...
  desktop_log "staged_asset source=$(installer_repo_join_var DIR_HOOKS_TARGET etc/skel/.dircolors) target=/etc/skel/.dircolors mode=0644"
  ...
  install -d -m 0700 /target/etc/skel/.config/zoom
  desktop_stage_role_asset etc/skel/.config/zoom/zoomus.conf /etc/skel/.config/zoom/zoomus.conf 0600
  chmod 0700 /target/etc/skel/.config/zoom
