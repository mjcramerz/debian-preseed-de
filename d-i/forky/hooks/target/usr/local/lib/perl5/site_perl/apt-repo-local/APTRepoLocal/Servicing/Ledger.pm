package APTRepoLocal::Servicing::Ledger;
...
sub _parse_metadata {
    my ($self, $path) = @_;
    my $raw = APTRepoLocal::Servicing::Atomic->read_limited($path, 65_536);
    my %fields;
...
sub apply {
    ...
    my $published = eval {
        ...
        system('/usr/bin/desktop-file-validate', '/usr/local/share/applications/ledger-live.desktop') == 0
