package APTRepoLocal::Servicing::Bitwarden;
...
sub _trusted_text {
    ...
    return undef if !@st
        ...
        || ($st[2] & 0022);
    my $text = eval {
        APTRepoLocal::Servicing::Atomic->read_limited($path, $limit);
    };
    return undef if $@;
    return $text;
}
    ...
    my @requirements = (
        ...
        [
            ...
            [
                ...
                '#include <abstractions/electron-application>',
